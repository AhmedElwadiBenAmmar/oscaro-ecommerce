...
<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div>
        ...
        <div class="mt-6 flex flex-wrap gap-3 items-center">
            ...
            {{-- Comparateur --}}
            @auth
                <form method="POST" action="{{ route('comparison.add', $piece->id) }}">
                    @csrf
                    <input type="hidden" name="product_id" value="{{ $piece->id }}">
                    <button type="submit"
                            class="px-4 py-2 border border-gray-400 text-sm font-semibold rounded hover:bg-gray-100">
